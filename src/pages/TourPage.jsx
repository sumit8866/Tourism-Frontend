...
import Accommodation from "../assets/image/five.png";
import Transfer from "../assets/image/airport.png";
import Meals from "../assets/image/healthy-meal.png";
import Sightseeing from "../assets/image/binocular.png";
      ...
      >
        <Box width={{ xs: "100%", md: "70%" }} mx={{ xs: "0px", md: "10px" }}>
          ...
          >
            ...
            <Typography variant="p"  fontWeight={'600'} fontSize={'18px'}> Tour and Services ends</Typography>
          </Box>
        </Box>
        <Box
          width={{ xs: "95%", md: "30%" }}
